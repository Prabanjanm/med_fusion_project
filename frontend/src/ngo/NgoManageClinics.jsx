...
import { UserPlus, Hospital, Mail, MapPin, Hash, ShieldCheck, ArrowLeft, Loader2, Search, Filter, CheckCircle, XCircle, MoreVertical, ExternalLink } from 'lucide-react';
                            ...
                            <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '1rem' }}>
                                <button
                                    ...
                                    style={{
                                        ...
                                        color: '#000', border: 'none', padding: '1rem 3rem', borderRadius: '12px',
                                        fontWeight: 800, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.75rem'
                                    }}
                                >
                                    {submitting ? <Loader2 className="spin-icon" /> : <ShieldCheck size={20} />}
                    ...
                    <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.8)', backdropFilter: 'blur(10px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9999 }}>
                        <div style={{ background: '#0f172a', padding: '2.5rem', borderRadius: '24px', border: '1px solid rgba(0, 229, 255, 0.2)', width: '100%', maxWidth: '500px' }}>
                            ...
                            <form onSubmit={handleNeedSubmit} style={{ display: 'grid', gap: '1.25rem' }}>
                                ...
                                <button type="submit" disabled={submitting} style={{ background: 'linear-gradient(135deg, #00e5ff 0%, #10b981 100%)', color: '#000', border: 'none', padding: '1rem', borderRadius: '12px', fontWeight: 800, cursor: 'pointer', marginTop: '1rem' }}>
                                    {submitting ? 'RECORDING...' : 'RECORD REQUIREMENT'}
                                </button>
                            </form>
                        </div>
                    </div>
